...
#define MACHINE_UUID "a3e674d3-3808-4b55-bd46-87a680afeff8"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  // MPO Note: PID Tune values (9.43, 0.48, 46.61) causing thermal overruns. Use the following, which have been more reliable
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 127.75 // was 19.6
  #define DEFAULT_bedKi 25.05 // was 3.91
  #define DEFAULT_bedKd 434.36 // was 65.4
