...
#define STRING_CONFIG_H_AUTHOR "(Elvantech, SKR-V1.4 LPC1768)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Vulcanus Max"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  16.08,  16.76 }
    #define DEFAULT_Ki_LIST {   0.93,   1.03 }
    #define DEFAULT_Kd_LIST { 69.56, 68.06 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 19.6
  #define DEFAULT_bedKi 3.91
  #define DEFAULT_bedKd 65.4
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 395.62,  478.11 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -17, 0, 0 }
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // MPO ELVANTECH
