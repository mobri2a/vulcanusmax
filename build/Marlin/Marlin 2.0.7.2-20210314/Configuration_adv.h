 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       1500 // MPO ELVANTECH higher value for 2 motors
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      446 // MPO ELVANTECH 
    #define E0_MICROSTEPS    16
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only MPO ELVANTECH
    ...
    #define X_STALL_SENSITIVITY  100 // MPO ELVANTECH
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  100 // MPO ELVANTECH
