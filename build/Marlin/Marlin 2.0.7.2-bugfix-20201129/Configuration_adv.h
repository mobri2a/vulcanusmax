 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // MPO ELVANTECH Fan comes on at 50c
 ...
 */
#define BABYSTEPPING // MPO ELVANTECH
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. MPO ELVANTECH
 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       1350 // MPO ELVANTECH
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      800 // Needs to be calculated MPO ELVANTECH
    #define E0_MICROSTEPS    16
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only MPO ELVANTECH

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  60 // MPO ELVANTECH
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  60 // MPO ELVANTECH
